...
//   return (
//     <section className="  lg:p-4 p-3 grid gap-6">
//       {goalsData.map(({ image, bgColor, title, description, buttonText }) => (
//         <div
//           key={title}
//           className={`flex flex-col sticky w-full top-[calc(8%+var(--plan-offset))] lg:flex-row ${bgColor} rounded-2xl p-6 items-center `}
//           style={{
//             position: 'sticky',
//             top: '100px', 
